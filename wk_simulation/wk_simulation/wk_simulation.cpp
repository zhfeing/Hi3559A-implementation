...
int main()
{
    ...
    // set file path
    string wk_file_name = "./caffe_converted_sim_huge.wk";
    ...
    int img_id = 1;
    string img_file_name = img_file_path + std::to_string(img_id) + ".png";
    ...
    cout << "cost: " << time_cost / 1000.0 / 100.0 << "ms" << endl;
#endif // __ARM_ARCH

    ofstream img_out("img_out_1.txt");
    for (int i = 0; i < 2 * 720 * 1280; i++)
    {
